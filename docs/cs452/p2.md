<figure>
<img src="images/p2-meme.png" alt="P2 Meme" />
</figure>
...
This project is requires significant time to complete if you are using
windows. If you are using windows you should start early and expect to
spend at least 10 additional hours. It is **strongly recommend** that
you complete this project on a Linux machine and only attempt windows
once you have a fully working Linux version.
...
-   1.4 Apply computer science theory and software development
    fundamentals to produce computing-based solutions. **(ABET Outcome
    6)**
...
header file `labconfig.h` for the major and minor version. Parse the
...
-   [History
    Docs](https://tiswww.cwru.edu/php/chet/readline/history.html)
...
-   [glibc - Initializing the
    Shell](https://www.gnu.org/software/libc/manual/html_node/Initializing-the-Shell.html)

-   [glibc - Launching
    Jobs](https://www.gnu.org/software/libc/manual/html_node/Launching-Jobs.html)
