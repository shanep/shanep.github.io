...
<<< @/cs452/code/p5/lab.h{c}

### app/main.c

<<< @/cs452/code/p5/main.c
...
`student_plot.png`. Two example plots are shown below, that show the same
code running on two different machines.

![example plot](images/student_plot.png)
![example plot](images/student_plot2.png)
