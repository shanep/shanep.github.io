...
\begin{itemize}
  ...
  \ressubheading
      {\includegraphics[scale=.1]{fc.png}}
   ...
   \ressubheading
       {\includegraphics[scale=.039]{hp.png}}
...
\subsection*{Internal - Boise State University}
\begin{itemize}
...
\begin{itemize}
  \item \href{https://conf.researchr.org/track/esem-2024/esem-2024-technical-track}{ESEM 2024 conference} - Sub-reviewer for conference technical papers track
\end{itemize}
