...
WARNING: While no intentional bugs have be inserted into the starter code it is
possible that some bugs may have been overlooked. If you think you have found
a bug notify your professor ASAP.
