...
Unless otherwise stated all code must compile using github codespaces.
https://github.com/features/codespaces[GitHub Codespaces] is free to use for up
to 60 hours per month and can be accessed with any modern browser. If you run
out of free hours you do not have to pay to continue using codespaces. You can
complete all the assignments using a virtual machine or your own computer.
...
| <<Testing>>
| 50%
| Passes 100% of instructor test suite and student authored tests cover all functions
| Passes between 90% and 99% of instructor test suite or student authored tests cover most functions
| Passes between 80% and 89% of instructor test suite or minimal student authored tests
| Passes less then 80% of instructor test suite or no student authored tests
