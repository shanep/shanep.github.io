...
* xref:projects/p2.adoc[Project 2] - In this project you will
write a simple shell to get a better understanding of processes.
* xref:projects/p3.adoc[Project 3] - In this project you will
...
* xref:projects/p5.adoc[Project 5] - In this project we will
