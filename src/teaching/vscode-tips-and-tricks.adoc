...
image::images/vscode-default-terminal.png[Set Default Terminal]
...
image::images/vscode_remote_devel.gif[Visual walk through]
...
image::images/vscode_connected.png[VSCode connected]
...
image::images/vscode-remote-extensions.png[VSCode remote extensions]
...
image::images/start-codespaces.gif[start codespaces]
...
image::images/vscode-live-preview.png[VSCode Live preview]
...
image::images/vscode-live-preview-problems.png[VSCode Live preview problems]
...
image::images/vscode-port-forward.gif[VSCode connected]
...
image::images/codespaces-tool-bar.png[codespaces toolbar]
...
image::images/all-codespaces.png[All Codespaces]

Then you should see all the Codespaces that you have created and can use!

image::images/all-codespaces-view.png[All Codespaces view]
...
image::images/github-settings.png[Github settings]

image::images/github-settings-codespaces.png[Github settings codespaces]

image::images/github-settings-codespaces-default-idle.png[Github settings idle]
...
image::images/pointer_as_array_bad.png[Pointer not showing the full array]
...
image::images/setting_watch_vscode.gif[Watch var showing the full array]
