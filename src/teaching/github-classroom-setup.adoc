...
class and also enrolled as a student in another. Github has great
...
that will walk you through creating a new organization. I create a new
organization each semester that is specific to the class with the naming
convention cs123-fall2020.

image::../images/teaching/github-orgs.png[Github Orgs]
...
There are three options for starter code repositories that you can choose, each
are detailed below. All starter code repositories must be setup as a template
repository in order to use github classrooms. Refer to the github documentation
on how to
...
functionality. A suggested format is to name your classroom the same name as the
organization that you will be using to host the repositories.
...
image:../images/teaching/github-classroom-assignment-url.png[Classroom assignment url]
...
Github provides a cross platform command line downloader that you can use to get
all your student submissions. Complete instructions on how to install and use
the downloader are provided
https://docs.github.com/en/education/manage-coursework-with-github-classroom/teach-with-github-classroom/using-github-classroom-with-github-cli[here].
