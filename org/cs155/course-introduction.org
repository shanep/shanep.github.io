...
labs. Git can only be mastered by *lots* of practice so we will be doing
a lot of labs that involve interacting with existing repositories. In
future classes you will then start to use Git when working on team
assignments.
...
We will be using a free (but well written) book for this module which you can [[https://drive.google.com/file/d/1nJ0XC0H7eI5I_g9WCqY9v-LlBMREaRBe/view?usp=share_link][download here]]. Once
you have downloaded the book read the following chapters as well as the post on the integrated
terminal in VSCode before you attempt the homework section.
...
- [[../teaching/vscode-tips-and-tricks.org][Install VSCode and Git]]
...
watch and give feedback on. If you have a question please send a *direct
email* to your instructor as I may not see questions asked in the middle
of a video.
