...
#+TITLE: Syllabus Boilerplate
#+SUBTITLE: General Syllabus Statements for all courses
#+DATE: <2024-08-01 Thu>
...
- **office hours:** Book on the canvas homepage
...
**Typos and Bugs** If you find any typos or bugs in the course that are hosted on GitHub materials,
you can make the corrections and then issue a [[https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request][pull request]]. If I merge your changes back into the
...
points offered.  Creating a pull request is important and is the core learning objective in the
extra credit process. If the typo or bug is within canvas you will need to submit the correction to
the canvas assignment named "Canvas Typos and bugs".
...
your assigned work. However, I strongly encourage anyone who is learning to *NOT* use AI or even an
IDE. When you are learning something new it is OK to struggle and get things wrong that is part of
the learning process. If you do choose to use AI you *must cite* your usage and you will now be
graded on the code that it writes. If you truly believe that ChatGPT can *always* give the best
solution to any problem then you may want to switch majors because why would a company hire you if
they can just use ChatGPT to write all their code?
...
#+begin_src java
  ...
  //Walk the list every time you call size
  public int size() {
      int size = 0;
      Node current = head;
      while (current != null) {
...
#+begin_src java
  ...
  //store the size var and just return it.
  public int size() {
      return size;
  }
#+end_src
