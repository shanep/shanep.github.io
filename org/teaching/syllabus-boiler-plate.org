...
#+SUBTITLE: General Syllabus Statements for all syllabi
#+DATE: <2024-08-01 Thu>

* Overview

Below are statements that are common to all syllabi and statements that are required by Boise State
University. These statements are to be combined with course specific learning objects and
schedules. The full syllabus for each course is stored in canvas.
...
corrections on GitHub, and then issue a [[https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request][pull request]]. If I merge your changes back into the
...
process. No points will be awarded for any other method of submission.
